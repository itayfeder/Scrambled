package com.itayfeder.scrambled.entities.goals;
...
public class TemptByCrownGoal extends Goal {
    ...
    public TemptByCrownGoal(PathfinderMob p_25939_, double p_25940_, boolean p_25942_) {
        this.mob = p_25939_;
    ...
    private boolean shouldFollow(LivingEntity p_148139_) {
        Ingredient ingredient = Ingredient.of(ItemInit.FLOWER_CROWN.get());
        return ingredient.test(p_148139_.getItemBySlot(EquipmentSlot.HEAD));
    }
